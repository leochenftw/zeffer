        	...
        	<div class="panel">
        		...
        		<div class="container_12 border-bottom">
        			<div class="grid_6">
						...
						<p>After long wintery nights crushing, an exploding fruit press, experimental brews and many hours spent hand bottling, we had </p>
        			</div>
        			<div class="grid_6">
        				<p>our first batch ready for release in the Spring of 2009. We sold it exclusively through our local Matakana Farmers market and were rewarded with great feedback, eager buyers and steady growth which ultimately allowed us to build our own cidery. And, while we are now the proud owners of a shiny new fruit press we remain faithful to our simple vision and ethos of making cider that we are both proud to put our name on and love to drink.</p> 
						<p>Our ciders are fermented in small batches and made with minimal intervention that allows the natural flavours and true character to shine without the use of any artificial colours or sweeteners. We love what we do and we love that we get to share it with you.</p>
						<strong>From the Team at Zeffer</strong>
        			</div>
        		</div>
        	</div>
        </section>
